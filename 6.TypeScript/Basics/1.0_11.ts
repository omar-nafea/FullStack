...
// Type Anootations with Variables (Union Types - Multiple Types)
// allOfThem = "Osman" // String
// allOfThem = 100 // Number
// allOfThem = true // Boolean
// allOfThem = [1, 2, 3] // Array - Not Allowed
...
// Rest Parameters allow us to pass a variable number of arguments to a function
// and are defined using the `...` syntax followed by a type annotation.
// The rest parameter must be the last parameter in the function signature.

// type of Rest Parameterers is an array of the specified type
